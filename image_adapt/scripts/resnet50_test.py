...
#     imagenet_class_index_path = "/home/yfj/imagenet_class_index.json"
...
def main():
    ...
    # # 设置数据路径
    # args.data_dir1 = f"/home/yfj/imagenet-c/{args.corruption}/{args.severity}"
    # args.data_dir2 = f"/home/yfj/ImageNet-C-Syn/{args.corruption}/{args.severity}"
    # logger.log(f"当前域： (corruption): {args.corruption}, severity: {args.severity}")
   ...
   # optimizer_classifier = AdamW(source_classifier.parameters(), lr=learning_rate, weight_decay=1e-5)
    ...
    with tqdm(total=total_samples, desc="Initializing memory bank", unit="sample") as pbar:
        for idx, batch_data in enumerate(data_loader):
            ...
            with th.no_grad():
                ...
                features_x2 = source_net_frozen2.neck(features_x2)
    ...
    #             features_x1 = source_net_frozen2.neck(features_x1)
